...
def load_model(model_class, path, config=None, torch_dtype=torch.bfloat16, device="cpu", state_dict_converter=None, use_disk_map=False, module_map=None, vram_config=None, vram_limit=None, state_dict=None, state_dict_keys=None):
    ...
    if module_map is not None:
        ...
        if vram_config["offload_device"] != "disk":
            ...
            if state_dict_keys is not None:
                state_dict = {i: state_dict[i] for i in state_dict_keys if i in state_dict}
            else:
