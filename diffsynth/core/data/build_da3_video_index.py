...
def build_parser():
    parser = argparse.ArgumentParser(
        description="Pre-scan DA3 video datasets into a SQLite training index."
    )
    parser.add_argument(
        "--camera_params_path",
        required=True,
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Debug cap applied independently to each comma-separated "
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Disable tqdm progress bars and debug summaries.",
    )
    parser.add_argument(
        "--overwrite",
        default=False,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Require prompt, extrinsic, intrinsic, depth, video and frame_count. "
            "Enabled by default."
        ),
    )
    parser.add_argument(
        ...
        dest="require_complete",
        action="store_false",
        help="Record incomplete scenes for diagnostics; not recommended for training.",
    )
    parser.add_argument(
        ...
        help=(
            ...
            "mask JSONL before it is kept in the training index."
        ),
    )
    parser.add_argument(
        "--dynamic_mask_subdir",
